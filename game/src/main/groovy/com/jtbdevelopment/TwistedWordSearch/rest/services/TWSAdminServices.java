...
@Component
public class TWSAdminServices extends
    AbstractAdminServices<ObjectId, GameFeature, TWSGame, MongoPlayer> {

  TWSAdminServices(final AbstractPlayerRepository<ObjectId, MongoPlayer> playerRepository,

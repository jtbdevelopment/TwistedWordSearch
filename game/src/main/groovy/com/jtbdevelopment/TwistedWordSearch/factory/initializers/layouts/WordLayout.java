...
public enum WordLayout {
  HorizontalForward(0, 1), HorizontalBackward(0, -1), VerticalDown(1, 0), VerticalUp(-1,
      0), SlopingDownForward(1, 1), SlopingDownBackward(-1, -1), SlopingUpForward(-1,
      1), SlopingUpBackward(1, -1);

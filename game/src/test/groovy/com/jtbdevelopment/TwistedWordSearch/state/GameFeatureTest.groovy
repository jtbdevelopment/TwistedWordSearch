...
class GameFeatureTest extends GroovyTestCase {
    void testGetGroupedFeatures() {
        assert [
                (GameFeature.Grid)             : [GameFeature.Grid40X40, GameFeature.Grid20X20, GameFeature.CircleX20, GameFeature.CircleX40, GameFeature.PyramidX20, GameFeature.PyramidX40],

 ...
 */
public class ScoreInitializerTest extends MongoGameCoreTestCase {

  private ScoreInitializer initializer = new ScoreInitializer();
  ...
  public void testInitializeGame() {
    ...
    Assert.assertEquals(map, game.getScores());
  }
